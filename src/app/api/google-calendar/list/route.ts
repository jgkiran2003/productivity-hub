...
export async function GET() {
  ...
  try {
    ...
    console.error('Google Calendar API Error:', googleApiError);
    ...
    return NextResponse.json({ error: googleApiError.message || 'Failed to fetch Google Calendar events' }, { status: 500 });
  }
}
